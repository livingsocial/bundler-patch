...
describe ConservativeResolverV1_13 do
  before do
    skip 'Testing against Bundler <= 1.12' unless bundler_1_13?
  ...
  context 'conservative resolver' do
    ...
    before do
      ...
      @cr = ConservativeResolverV1_13.new(nil, {}, [], @gvp)
    ...
    context 'caching search results' do
      before do
        ...
        gvp = Bundler::GemVersionPromoter.new
        @cr = ConservativeResolverV1_13.new(index, {}, Bundler::SpecSet.new([]), gvp)
